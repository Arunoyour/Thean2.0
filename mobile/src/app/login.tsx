    ...
    <SafeAreaView style={commonStyles.screen}>
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={commonStyles.scrollContent} keyboardShouldPersistTaps="handled">
          <Text style={commonStyles.eyebrow}>Secure access</Text>
          <Text style={commonStyles.title}>Customer login</Text>
          <Text style={commonStyles.lead}>
            Login through OTP. Your secure token is stored with platform secure storage.
          </Text>
          ...
          <View style={commonStyles.card}>
            ...
            {phase === 'verify' ? (
              <Pressable
                ...
                <Text style={styles.textButton}>Change phone number</Text>
              </Pressable>
            ) : null}

            <Text style={styles.footerText}>
              New customer? <Link href="/register" style={styles.footerLink}>Create an account</Link>
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
