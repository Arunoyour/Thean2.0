...
class AuditAction:
    ...
    # Haircut
    APPROVE_HAIRCUT_VENDOR  = "APPROVE_HAIRCUT_VENDOR"
    REJECT_HAIRCUT_VENDOR   = "REJECT_HAIRCUT_VENDOR"
    UPDATE_HAIRCUT_SHOP     = "UPDATE_HAIRCUT_SHOP"
    CREATE_HAIRCUT_CLOSURE  = "CREATE_HAIRCUT_CLOSURE"
