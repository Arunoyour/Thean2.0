...
import { AlertTriangle, ArrowLeft, CheckCircle2, IndianRupee, Package, RefreshCw, Truck } from "lucide-react";
import { getDeliveryAttention } from "../lib/api.js";
...
export function DeliveryAttentionPage() {
  ...
  return (
    <div className="dl-page">
      <header className="dl-inner-header" style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        <Link to="/home" style={{ color: "#6b7280", display: "flex" }}><ArrowLeft size={20} /></Link>
        <h1 style={{ margin: 0, fontSize: "1.1rem", fontWeight: 700 }}>Attention Needed</h1>
      ...
      <div style={{ padding: "1rem" }}>
        {loading && (
          <div className="dl-loading">
            <RefreshCw size={24} className="dl-spin" />
            <p>Checking…</p>
          </div>
        )}
        ...
        {!loading && data && data.count === 0 && (
          <div className="dl-no-order-card">
            ...
            <p style={{ fontWeight: 600, marginTop: "0.5rem" }}>All clear</p>
            <p style={{ fontSize: "0.85em", color: "#9ca3af", marginTop: "0.35rem" }}>No items need your attention right now.</p>
          </div>
        )}
